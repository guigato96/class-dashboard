  ...
  return (
    <div
      style={{
        ...
        backgroundImage:
          "radial-gradient(circle at 50% -10%, var(--glow-purple), transparent 55%), radial-gradient(var(--hover-bg) 1px, transparent 1px)",
    ...
    >
      ...
      <div className="w-full max-w-sm">
        <div className="flex items-center justify-center mb-6">
          <img src={logoClass} alt="Class" className="h-10 w-auto app-logo" />
        </div>
